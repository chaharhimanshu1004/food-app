...
export default function Navbar() {
  return (
    <div className='bg-[#323334] w-[393px] h-[240px]'>
        <div  className='flex  flex-col w-[285px]  h-[129px] pt-[25px] ml-[54px] mr-[54px]'>
            ...
            <div className='border-[1px] mt-[18px] text-white pt-[11px] pl-[15px] pr-[157px] pb-[10px] rounded-[5px]' style={{borderColor:'#FF0909'}}>
                <input  type="text" className='font-[16px]  bg-[#323334] font-[400] leading-normal' placeholder='Search Food....' />
            </div>
        </div>
